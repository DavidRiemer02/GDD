...
num_trees_to_plot = 4  #Number of trees to plot
...
for i in range(num_trees_to_plot):
    ...
    'Ratio of numerical to categorical columns', 'Functional Dependencies Ratio', 'Unique Column Combinations Ratio', 'Inclusion Dependencies Ratio', 'Max FD Length Normalized', 'Functional Dependencies Count', 'Unique Column Combinations Count',
