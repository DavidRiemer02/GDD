...
public class Configuration {
    ...
    public static final String METRIC_PACKAGE_NAME = "de.unimarburg.generateddatasetdetector.evaluation.metric"; // TODO: fetch from reflection so it is easy to refactor
    public static final String MATCHING_PACKAGE_NAME = "de.unimarburg.generateddatasetdetector.matching"; // TODO: fetch from reflection so it is easy to refactor
    public static final String TOKENIZATION_PACKAGE_NAME = "de.unimarburg.generateddatasetdetector.preprocessing.tokenization"; // TODO: fetch from reflection so it is easy to refactor
