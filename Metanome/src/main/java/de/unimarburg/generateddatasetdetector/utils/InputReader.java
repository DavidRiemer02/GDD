...
import de.unimarburg.generateddatasetdetector.data.metadata.DatabaseMetadata;
...
import de.unimarburg.generateddatasetdetector.data.metadata.dependency.Metanome;
...
public class InputReader {
    ...
    public static Table readDataFile(String inputPath, String separator) {
        CSVFormat csvFormat = CSVFormat.DEFAULT.withQuote(null).builder()
                .setHeader()
